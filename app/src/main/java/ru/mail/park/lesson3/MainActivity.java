...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putCharSequence(textKey1, text1.getText());
        outState.putCharSequence(textKey2, text2.getText());
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            text1.setText(savedInstanceState.getCharSequence(textKey1));
            text2.setText(savedInstanceState.getCharSequence(textKey2));
        }
    }
}
